...
mod tests {
    ...
    test_component!(esp32_s3_wroom1, "C2913204"); // fail
    test_component!(usb_c_conn_1, "C2765186");
    test_component!(usb_c_conn_2, "C165948");
    test_component!(hdmi_conn_1, "C136421"); // fail
    ...
    test_component!(relay_1, "C93168"); // fail
    test_component!(relay_2, "C968857");
    test_component!(relay_3, "C2753312"); // fail; unsupported pad shape
    test_component!(relay_4, "C192257"); // fail; unsupported fill shape
    ...
    test_component!(son_8, "C3680787"); // fail; VIA undefined in FP parser
